...
function draw() {
  ...
  if (gameState == "start") {
    ...
    fill("white");
    textSize(20);
    text(" Welcome to the Bunny Game!", 70, 46);
...
function obstacles() {
  if (World.frameCount % 80 === 0) {
    var obstacle = createSprite(405, 110, 20, 20);
    //obstacle.debug = true;
...
function spawnBricks() {
  if (World.frameCount % 70 === 0) {
    var brick = createSprite(610, random(200, 400), 30, 30);
...
function coins() {
  if (World.frameCount % 100 === 0) {
    var coin = createSprite(610, random(100, 400), 30, 30);
